...
**Windows 教程:** [https://github.com/devagame/apps-vums/blob/master/README_WIN.md](docs/README_WIN.md)

**Linux  教程:**  [https://github.com/devagame/apps-vums/blob/master/README_LINUX.md](docs/README_LINUX.md)

**PDF 导出配置教程**  [https://github.com/devagame/apps-vums/blob/master/docs/README_LINUX.md](docs/WKHTMLTOPDF.md)

对于没有Golang使用经验的用户，可以从 [https://github.com/devagame/apps-vums/releases](https://github.com/devagame/apps-vums/releases) 这里下载编译完的程序。
